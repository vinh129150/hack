...
function Quest.CheckQuest()
    ...
    if World1 then
        ...
        elseif MyLevel >= 375 and MyLevel <= 399 then
            ...
            if getgenv().AutoFarm and (CFrameQuest.Position - plr.Character.HumanoidRootPart.Position).Magnitude > 10000 then
        ...
        elseif MyLevel >= 450 and MyLevel <= 474 then
            ...
            if getgenv().AutoFarm and (CFrameQuest.Position - plr.Character.HumanoidRootPart.Position).Magnitude > 10000 then
                CommF_:InvokeServer("requestEntrance", Vector3.new(-4607.82275, 872.54248, -1667.55688))
            end
    ...
    elseif World2 then
        ...
        elseif MyLevel >= 1350 and MyLevel <= 1374 then
            ...
            if getgenv().AutoFarm and (CFrameQuest.Position - plr.Character.HumanoidRootPart.Position).Magnitude > 10000 then
                CommF_:InvokeServer("requestEntrance", Vector3.new(-6508.5581054688, 5000.034996032715, -132.83953857422))
            end
    ...
    elseif World3 then
        ...
        elseif MyLevel >= 2625 and MyLevel <= 2649 then
            ...
            if getgenv().AutoFarm and (CFrameQuest.Position - plr.Character.HumanoidRootPart.Position).Magnitude > 10000 then
                topos(CFrame.new(-16269.7041, 25.2288494, 1373.65955)) task.wait(2)
                ReplicatedStorage.Modules.Net:FindFirstChild("RF/SubmarineWorkerSpeak"):InvokeServer("TravelToSubmergedIsland")
            end
...
function Quest.CancelQuest()
    CommF_:InvokeServer("CancelQuest")
end
CancelQuest = Quest.CancelQuest
