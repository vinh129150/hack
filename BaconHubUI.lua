...
local ServerLink = "https://discord.gg/xccBvmumJ"
local WarnMessage = "Bacon Hub announcement! We have detected that the CC script is renaming our script and creating a key system to make money. Please join our Discord to get the script without a key system."
