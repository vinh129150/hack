...
local T1UIColor = {
	...
	["Title Text Color"] = Color3.fromRGB(30, 80, 180),
	...
	["Background Image"] = "",
	["Page Selected Color"] = Color3.fromRGB(30, 80, 180),
	["Section Text Color"] = Color3.fromRGB(220, 220, 210),
	["Section Underline Color"] = Color3.fromRGB(30, 80, 180),
	["Toggle Border Color"] = Color3.fromRGB(30, 80, 180),
	["Toggle Checked Color"] = Color3.fromRGB(230, 230, 230),
	["Toggle Desc Color"] = Color3.fromRGB(185, 185, 185),
	["Button Color"] = Color3.fromRGB(30, 80, 180),
	["Label Color"] = Color3.fromRGB(38, 38, 42),
	["Dropdown Icon Color"] = Color3.fromRGB(230, 230, 230),
	["Dropdown Selected Color"] = Color3.fromRGB(30, 80, 180),
	["Dropdown Selected Check Color"] = Color3.fromRGB(20, 60, 150),
	["Textbox Highlight Color"] = Color3.fromRGB(30, 80, 180),
	["Box Highlight Color"] = Color3.fromRGB(30, 80, 180),
	["Slider Line Color"] = Color3.fromRGB(30, 80, 180),
	["Slider Highlight Color"] = Color3.fromRGB(15, 45, 130),
...
local libCreateNoti = function(Setting)
    ...
    TextLabelNoti.Text = "<font color=\"rgb(" .. tostring(color or "255,80,80") .. ")\">" .. tostring(TitleNameMain or "Bacon Hub") .. "</font> " .. tostring(getgenv().TitleNameNoti or "")
...
function Library:CreateWindow(Setting)
    local TitleNameMain = Setting.Title or "Bacon Hub"
	...
	local colorB = tostring(Library_Function.Getcolor(getgenv().UIColor['Title Text Color'])[3])
	local color = colorR .. ',' .. colorG .. ',' .. colorB
    TextLabelMain.Text = "<font color=\"rgb(" .. tostring(color or "255,80,80") .. ")\">" .. tostring(TitleNameMain or "Bacon Hub") .. "</font> " .. tostring(getgenv().MainDesc or "")
	...
	function Main_Function:AddTab(PageName)
		...
		function pageFunction:AddSection(Section_Name, Toggleable, SectionGap, SectionColor)
			...
			function sectionFunction:AddToggle(idk,Setting)
				...
				check.BackgroundColor3 = Color3.fromRGB(30, 80, 180)
        ...
        function sectionFunction:AddButton(Setting, Callback)
            ...
            TextColor_1.Parent = RowBG_1
             ...
             ClickArea_1.BackgroundColor3 = Color3.fromRGB(30, 80, 180)
             ...
             UIGradient_1.Color = ColorSequence.new{
                 ColorSequenceKeypoint.new(0, Color3.fromRGB(40, 100, 210)), 
                 ColorSequenceKeypoint.new(0.4, Color3.fromRGB(30, 80, 180)), 
                 ColorSequenceKeypoint.new(0.6, Color3.fromRGB(20, 65, 160)), 
                 ColorSequenceKeypoint.new(1, Color3.fromRGB(15, 50, 140))
             }
